    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse" style="">
        ...
        <ul class="nav navbar-nav mr-auto">
          ...
          <li class="nav-item">    
            <a {!! App\Helpers\GoogleAnalyticsHelper::onClickEvent('TopNavigation', 'Latest') !!} href="{{ action('App\Http\Controllers\Nexus\SectionController@latest')}}" class="nav-link mr-1">
            <span class="oi oi-pulse mr-1" aria-hidden="true"></span> Latest</a>
          </li>

          <li class="nav-item">
            <a {!! App\Helpers\GoogleAnalyticsHelper::onClickEvent('TopNavigation', 'Catch-Up') !!} href="{{ action('App\Http\Controllers\Nexus\SectionController@leap')}}" class="nav-link mr-1" dusk="toolbar-next">
            <span class="oi oi-arrow-circle-right mr-1" aria-hidden="true"></span> Next</a>
          </li> 

            <a {!! App\Helpers\GoogleAnalyticsHelper::onClickEvent('TopNavigation', 'Users') !!} href="{{ action('App\Http\Controllers\Nexus\UserController@index')}}" class="nav-link">
            <span class="oi oi-people mr-1" aria-hidden="true"></span> Users</a>
          </li>

          <li class="nav-item">    
            <a {!! App\Helpers\GoogleAnalyticsHelper::onClickEvent('TopNavigation', 'Whos Online') !!} href="{{ action('App\Http\Controllers\Nexus\ActivityController@index')}}" class="nav-link mr-1">
          ...
          <li class="nav-item replace-with-vue">
            <a {!! App\Helpers\GoogleAnalyticsHelper::onClickEvent('TopNavigation', 'Search') !!} href="{{ action('App\Http\Controllers\Nexus\SearchController@index')}}" class="nav-link mr-1">
        ...
        <ul class="nav navbar-nav ml-auto">
            <li class="dropdown nav-item"> 
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="mentiondropdown">
                  ...
                  <form class="form-inline" action="{{action('App\Http\Controllers\Nexus\MentionController@destroyAll')}}" method="POST">
                  @csrf
                  @method('DELETE')
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown nav-item">
            ...
            <div class="dropdown-menu" aria-labelledby="profiledropdown">
                <a class="dropdown-item" href="{{ action('App\Http\Controllers\Nexus\UserController@show', ['user' => $authUser->username])}}"> 
