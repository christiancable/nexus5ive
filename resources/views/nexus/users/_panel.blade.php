<div class="card text-center mb-3 bg-light">
    <div class="card-header bg-dark text-white">
        <a href="{{action('App\Http\Controllers\Nexus\UserController@show', ['user' => $user->username]) }}" class="d-block text-white"><h3 class="card-title mb-0">{{$user->username}}</h3></a>
    </div>
    <div class="card-body">
        @if($user->name)
        ...
        <p><a href="{{action('App\Http\Controllers\Nexus\UserController@show', ['user' => $user->username]) }}" class="btn btn-primary">View Profile</a></p>
    </div>
